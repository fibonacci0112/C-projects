========================================================================
    KONSOLENANWENDUNG: c++ test 1-Projektübersicht
========================================================================

Diese c++ test 1-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre c++ test 1-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "c++ test 1.pch und eine 
